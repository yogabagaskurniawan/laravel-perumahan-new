        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            searchInput.addEventListener("input", function() {
                ...
                rows.forEach(row => {
                    ...
                    const date = row.querySelector("td:nth-child(2) .table-inner-text").textContent.toLowerCase();
                    const sales = row.querySelector("td:nth-child(3)").textContent.toLowerCase();
                    const status = row.querySelector("td:nth-child(4) .badge").textContent.toLowerCase();
    
                    if (name.includes(searchTerm) || date.includes(searchTerm) || sales.includes(searchTerm) || status.includes(searchTerm)) {
                        row.style.display = "";
                    } else {
